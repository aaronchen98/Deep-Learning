...
YOLO_small.ckpt: https://pan.baidu.com/s/1mhE0WL6
"""
...
class Yolo(object):
    ...
    def _conv_layer(self, x, id, num_filters, filter_size, stride):
        ...
        conv = tf.nn.conv2d(x_pad, weight, strides=[
    ...
    def detect_from_file(self, image_file, imshow=True, deteted_boxes_file="boxes.txt",
        ...
        self.show_results(image, predict_boxes, imshow,
                          deteted_boxes_file, detected_image_file)
